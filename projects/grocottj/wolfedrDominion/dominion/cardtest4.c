...
int testMine() {
  ...
  //refactored for drew wolfe dominion.c assignment #5
  result = cardEffect(mine, 4, silver, 0, &state, HANDPOS, 0);
  ...
  memcpy(&preState, &state, sizeof(struct gameState));
	...
	//refactored for drew wolfe dominion.c assignment #5
  result = cardEffect(mine, baron, silver, 0, &state, HANDPOS, 0);
...
//refactored for drew wolfe dominion.c assignment #5
  result = cardEffect(mine, copper, treasure_map+999, 0, &state, HANDPOS, 0);
...
//refactored for drew wolfe dominion.c assignment #5
  result = cardEffect(mine, copper, curse-999, 0, &state, HANDPOS, 0);
  ...
  //refactored for drew wolfe dominion.c assignment #5
  result = cardEffect(mine, copper, estate, 0, &state, HANDPOS, 0);
...
//refactored for drew wolfe dominion.c assignment #5
  result = cardEffect(mine, copper, gold, 0, &state, HANDPOS, 0);
  ...
  //refactored for drew wolfe dominion.c assignment #5
  result = cardEffect(mine, 1, silver, 0, &state, HANDPOS, 0);
